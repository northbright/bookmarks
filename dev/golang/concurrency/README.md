...
* [Performance without the event loop(by Dave Cheney)](https://dave.cheney.net/2015/08/08/performance-without-the-event-loop)
* [Performance Without the Event Loop（中文译文）](https://zhuanlan.zhihu.com/p/65634302)
